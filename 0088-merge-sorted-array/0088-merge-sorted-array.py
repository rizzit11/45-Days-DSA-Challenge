...
# Logic: We start with three pointers—p1 = m - 1 pointing to the last valid element of nums1, p2 = n - 1 pointing to the last element of nums2, and p = m + n - 1 pointing to the last position in nums1. We compare nums1[p1] and nums2[p2] and place the larger one at nums1[p]. Depending on which value is larger, we adjust p1 or p2 accordingly. This way, we fill nums1 from the back,
